...
namespace Grapheme {
	...
	// Used in creating the API class CSTTEngine (see GraphemeSTT.h)
	// and the internal core engine class CSTTEngineImpl (see STTEngine.h)
	struct GRAPHEME_API SSTTConfig {
